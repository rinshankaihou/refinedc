...
Section code.
  ...
  Definition loc_125 : location_info := LocationInfo file_1 67 13 72 11.
  Definition loc_126 : location_info := LocationInfo file_1 67 15 67 19.
  Definition loc_127 : location_info := LocationInfo file_1 67 19 68 14.
  Definition loc_129 : location_info := LocationInfo file_1 68 10 68 14.
  Definition loc_130 : location_info := LocationInfo file_1 68 14 69 14.
  Definition loc_132 : location_info := LocationInfo file_1 69 10 69 14.
  Definition loc_133 : location_info := LocationInfo file_1 69 14 70 14.
  Definition loc_135 : location_info := LocationInfo file_1 70 10 70 14.
  Definition loc_136 : location_info := LocationInfo file_1 71 12 71 16.
  Definition loc_137 : location_info := LocationInfo file_1 71 14 71 15.
  Definition loc_138 : location_info := LocationInfo file_1 71 12 71 15.
  Definition loc_139 : location_info := LocationInfo file_1 71 14 71 15.
  Definition loc_140 : location_info := LocationInfo file_1 71 14 71 15.
  Definition loc_142 : location_info := LocationInfo file_1 70 10 70 11.
  Definition loc_143 : location_info := LocationInfo file_1 69 10 69 11.
  Definition loc_144 : location_info := LocationInfo file_1 68 10 68 11.
  Definition loc_145 : location_info := LocationInfo file_1 67 15 67 16.
  Definition loc_146 : location_info := LocationInfo file_1 72 19 72 24.
  Definition loc_147 : location_info := LocationInfo file_1 72 19 72 20.
  Definition loc_148 : location_info := LocationInfo file_1 72 19 72 20.
  Definition loc_149 : location_info := LocationInfo file_1 72 23 72 24.
  Definition loc_150 : location_info := LocationInfo file_1 62 10 62 15.
  Definition loc_151 : location_info := LocationInfo file_1 62 10 62 11.
  Definition loc_152 : location_info := LocationInfo file_1 62 10 62 11.
  Definition loc_153 : location_info := LocationInfo file_1 62 14 62 15.
  Definition loc_154 : location_info := LocationInfo file_1 61 10 61 21.
  Definition loc_155 : location_info := LocationInfo file_1 61 10 61 17.
  Definition loc_156 : location_info := LocationInfo file_1 61 11 61 12.
  Definition loc_157 : location_info := LocationInfo file_1 61 11 61 12.
  Definition loc_158 : location_info := LocationInfo file_1 61 15 61 16.
  Definition loc_159 : location_info := LocationInfo file_1 61 20 61 21.
  Definition loc_162 : location_info := LocationInfo file_1 59 10 59 11.
  ...
  Definition impl_duffs_identity : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "o" <-{ IntOp i32 } LocInfoE loc_162 (i2v 0 i32) ;
        "n" <-{ IntOp i32 }
          LocInfoE loc_154 ((LocInfoE loc_155 ((LocInfoE loc_156 (use{IntOp i32} (LocInfoE loc_157 ("i")))) +{IntOp i32, IntOp i32} (LocInfoE loc_158 (i2v 3 i32)))) /{IntOp i32, IntOp i32} (LocInfoE loc_159 (i2v 4 i32))) ;
        locinfo: loc_116 ;
        Switch i32
          (LocInfoE loc_150 ((LocInfoE loc_151 (use{IntOp i32} (LocInfoE loc_152 ("i")))) %{IntOp i32, IntOp i32} (LocInfoE loc_153 (i2v 4 i32))))
          (
            <[ 0 := 0%nat ]> $
            <[ 3 := 1%nat ]> $
            <[ 2 := 2%nat ]> $
      ...
      <[ "#3" :=
        locinfo: loc_129 ;
        LocInfoE loc_144 ("o") <-{ IntOp i32 }
          LocInfoE loc_129 ((LocInfoE loc_129 (use{IntOp i32} (LocInfoE loc_144 ("o")))) +{IntOp i32, IntOp i32} (LocInfoE loc_129 (i2v 1 i32))) ;
        locinfo: loc_130 ;
        Goto "#4"
      ]> $
      <[ "#4" :=
        locinfo: loc_132 ;
        LocInfoE loc_143 ("o") <-{ IntOp i32 }
          LocInfoE loc_132 ((LocInfoE loc_132 (use{IntOp i32} (LocInfoE loc_143 ("o")))) +{IntOp i32, IntOp i32} (LocInfoE loc_132 (i2v 1 i32))) ;
        locinfo: loc_133 ;
        Goto "#8"
      ]> $
      <[ "#5" :=
        locinfo: loc_146 ;
        if{IntOp i32, None}: LocInfoE loc_146 ((LocInfoE loc_147 (use{IntOp i32} (LocInfoE loc_148 ("n")))) >{IntOp i32, IntOp i32, i32} (LocInfoE loc_149 (i2v 0 i32)))
        then
        locinfo: loc_123 ;
          Goto "#6"
        else
      ...
      <[ "#6" :=
        ...
        LocInfoE loc_145 ("o") <-{ IntOp i32 }
          LocInfoE loc_126 ((LocInfoE loc_126 (use{IntOp i32} (LocInfoE loc_145 ("o")))) +{IntOp i32, IntOp i32} (LocInfoE loc_126 (i2v 1 i32))) ;
        locinfo: loc_127 ;
        Goto "#3"
      ]> $
      <[ "#7" :=
      ...
      <[ "#8" :=
        locinfo: loc_135 ;
        LocInfoE loc_142 ("o") <-{ IntOp i32 }
          LocInfoE loc_135 ((LocInfoE loc_135 (use{IntOp i32} (LocInfoE loc_142 ("o")))) +{IntOp i32, IntOp i32} (LocInfoE loc_135 (i2v 1 i32))) ;
        locinfo: loc_136 ;
        LocInfoE loc_137 ("n") <-{ IntOp i32 }
          LocInfoE loc_138 ((LocInfoE loc_139 (use{IntOp i32} (LocInfoE loc_140 ("n")))) -{IntOp i32, IntOp i32} (i2v 1 i32)) ;
        Goto "#5"
      ]> $
      <[ "#9" :=
        locinfo: loc_117 ;
