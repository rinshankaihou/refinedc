...
Global Arguments type_fixpoint {Σ _ A} _ _.
Lemma type_fixpoint_unseal `{!typeG Σ} {A} : type_fixpoint = @type_fixpoint_def Σ _ A.
...
Section fixpoint.
  ...
  Local Lemma type_fixpoint_own_eq T x l β :
    l ◁ₗ{β} type_fixpoint T x ⊣⊢ ∃ ty, ⌜∀ x, ty x ⊑ T ty x⌝ ∗ l ◁ₗ{β} ty x.
  Proof.
