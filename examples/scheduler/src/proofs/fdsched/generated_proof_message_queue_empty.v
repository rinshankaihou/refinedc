...
Section proof_message_queue_empty.
  Context `{!typeG Σ} `{!globalG Σ}.
  Context `{!PacketArrivals}.
  Context `{!mallocG Σ}.

  (* Typing proof for [message_queue_empty]. *)
  Lemma type_message_queue_empty :
    ⊢ typed_function impl_message_queue_empty type_of_message_queue_empty.
  Proof.
    Local Open Scope printing_sugar.
    start_function "message_queue_empty" ([data q]) => arg_q.
    ...
    - repeat liRStep; liShow.
      all: print_typesystem_goal "message_queue_empty" "#0".
    Unshelve. all: unshelve_sidecond; sidecond_hook; prepare_sideconditions; normalize_and_simpl_goal; try solve_goal; unsolved_sidecond_hook.
    all: print_sidecondition_goal "message_queue_empty".
    Unshelve. all: try done; try apply: inhabitant; print_remaining_shelved_goal "message_queue_empty".
  Qed.
End proof_message_queue_empty.
