...
Section spec.
  ...
  Global Instance fixed_size_map_simplify_goal_place_inst_generated l_ β_ patt__:
  ...
  Global Program Instance fixed_size_map_simplify_hyp_val_inst_generated v_ patt__:
    SimplifyHypVal v_ (patt__ @ fixed_size_map)%I (Some 100%N) :=
    λ T, i2p (simplify_hyp_val_eq v_ _ _ (fixed_size_map_unfold _) T _).
  Next Obligation. done. Qed.
  Global Program Instance fixed_size_map_simplify_goal_val_inst_generated v_ patt__:
