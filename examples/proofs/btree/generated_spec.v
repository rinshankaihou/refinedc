...
Section spec.
  ...
  Global Instance btree_t_simplify_goal_place_inst_generated l_ β_ patt__:
    SimplifyGoalPlace l_ β_ (patt__ @ btree_t)%I (Some 100%N) :=
    λ T, i2p (simplify_goal_place_eq l_ β_ _ _ T (btree_t_unfold _)).

  Global Program Instance btree_t_simplify_hyp_val_inst_generated v_ patt__:
    SimplifyHypVal v_ (patt__ @ btree_t)%I (Some 100%N) :=
    λ T, i2p (simplify_hyp_val_eq v_ _ _ (btree_t_unfold _) T _).
  Next Obligation. done. Qed.
  Global Program Instance btree_t_simplify_goal_val_inst_generated v_ patt__:
