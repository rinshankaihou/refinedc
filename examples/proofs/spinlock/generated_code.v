...
Section code.
  ...
  Definition loc_6 : location_info := LocationInfo file_0 8 3 8 17.
  Definition loc_7 : location_info := LocationInfo file_0 8 16 8 17.
  Definition loc_10 : location_info := LocationInfo file_0 12 2 12 21.
  ...
  Definition loc_14 : location_info := LocationInfo file_0 15 4 15 12.
  Definition loc_15 : location_info := LocationInfo file_0 15 15 15 16.
  Definition loc_16 : location_info := LocationInfo file_0 14 8 14 140.
  Definition loc_17 : location_info := LocationInfo file_0 14 8 14 128.
  Definition loc_18 : location_info := LocationInfo file_0 14 8 14 57.
  Definition loc_19 : location_info := LocationInfo file_0 14 58 14 69.
  Definition loc_20 : location_info := LocationInfo file_0 14 59 14 69.
  Definition loc_21 : location_info := LocationInfo file_0 14 59 14 63.
  Definition loc_22 : location_info := LocationInfo file_0 14 59 14 63.
  Definition loc_23 : location_info := LocationInfo file_0 14 71 14 80.
  Definition loc_24 : location_info := LocationInfo file_0 14 71 14 80.
  Definition loc_25 : location_info := LocationInfo file_0 14 72 14 80.
  Definition loc_26 : location_info := LocationInfo file_0 14 82 14 83.
  ...
  Definition impl_sl_init : function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_2 ;
        LocInfoE loc_3 ((LocInfoE loc_4 (!{PtrOp} (LocInfoE loc_5 ("lock")))) at{struct_spinlock} "lock") <-{ BoolOp, ScOrd }
          LocInfoE loc_7 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_7 (i2v 0 i32))) ;
        Return (VOID)
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_sl_lock : function := {|
    ...
    f_local_vars := [
      ("expected", bool_layout)
    ];
    f_init := "#0";
    f_code := (
      <[ "#0" :=
        "expected" <-{ BoolOp }
          LocInfoE loc_30 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_30 (i2v 0 i32))) ;
        locinfo: loc_11 ;
        Goto "#1"
      ]> $
      <[ "#1" :=
        locinfo: loc_16 ;
        if{IntOp i32, None}: LocInfoE loc_16 ((LocInfoE loc_17 (UnOp (CastOp $ IntOp i32) (BoolOp) (LocInfoE loc_17 (CAS
                             (BoolOp)
                             (LocInfoE loc_19 (&(LocInfoE loc_20 ((LocInfoE loc_21 (!{PtrOp} (LocInfoE loc_22 ("lock")))) at{struct_spinlock} "lock"))))
                             (LocInfoE loc_23 (UnOp (CastOp $ PtrOp) (PtrOp) (LocInfoE loc_24 (&(LocInfoE loc_25 ("expected"))))))
                             (LocInfoE loc_26 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_27 (i2v 1 i32)))))))) ={IntOp i32, IntOp i32, i32} (LocInfoE loc_28 (UnOp (CastOp $ IntOp i32) (BoolOp) (LocInfoE loc_28 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_29 (i2v 0 i32)))))))
        then
        locinfo: loc_13 ;
          Goto "#2"
        else
      ...
      <[ "#2" :=
        locinfo: loc_13 ;
        LocInfoE loc_14 ("expected") <-{ BoolOp }
          LocInfoE loc_15 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_15 (i2v 0 i32))) ;
        locinfo: loc_11 ;
        Goto "#1"
      ]> $
      <[ "#3" :=
  ...
  Definition impl_sl_unlock : function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_35 ;
        LocInfoE loc_38 ((LocInfoE loc_39 (!{PtrOp} (LocInfoE loc_40 ("lock")))) at{struct_spinlock} "lock") <-{ BoolOp, ScOrd }
          LocInfoE loc_41 (UnOp (CastOp $ BoolOp) (IntOp i32) (LocInfoE loc_41 (i2v 0 i32))) ;
        Return (VOID)
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_sl_lock_both (global_sl_lock : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_67 ;
        if{IntOp i32, None}: LocInfoE loc_67 ((LocInfoE loc_68 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_69 (use{PtrOp} (LocInfoE loc_70 ("a")))))) <{IntOp uintptr_t, IntOp uintptr_t, i32} (LocInfoE loc_71 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_72 (use{PtrOp} (LocInfoE loc_73 ("b")))))))
        then
        locinfo: loc_46 ;
          Goto "#1"
        else
  ...
  Definition impl_sl_lock_both_same_prov (global_sl_lock : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_99 ;
        if{IntOp i32, None}: LocInfoE loc_99 ((LocInfoE loc_100 (use{PtrOp} (LocInfoE loc_101 ("a")))) <{PtrOp, PtrOp, i32} (LocInfoE loc_102 (use{PtrOp} (LocInfoE loc_103 ("b")))))
        then
        locinfo: loc_78 ;
          Goto "#1"
        else
