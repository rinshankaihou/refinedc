...
Section code.
  ...
  Definition loc_56 : location_info := LocationInfo file_0 49 2 51 3.
  ...
  Definition loc_84 : location_info := LocationInfo file_0 64 2 66 3.
  ...
  Definition loc_342 : location_info := LocationInfo file_0 171 2 171 11.
  Definition loc_343 : location_info := LocationInfo file_0 172 2 172 11.
  Definition loc_344 : location_info := LocationInfo file_0 173 2 173 17.
  Definition loc_345 : location_info := LocationInfo file_0 174 2 174 36.
  Definition loc_346 : location_info := LocationInfo file_0 175 2 175 12.
  Definition loc_347 : location_info := LocationInfo file_0 175 9 175 11.
  Definition loc_348 : location_info := LocationInfo file_0 175 9 175 11.
  Definition loc_349 : location_info := LocationInfo file_0 175 10 175 11.
  Definition loc_350 : location_info := LocationInfo file_0 175 10 175 11.
  Definition loc_351 : location_info := LocationInfo file_0 174 11 174 35.
  Definition loc_352 : location_info := LocationInfo file_0 174 11 174 31.
  Definition loc_353 : location_info := LocationInfo file_0 174 17 174 31.
  Definition loc_354 : location_info := LocationInfo file_0 174 29 174 30.
  Definition loc_355 : location_info := LocationInfo file_0 174 29 174 30.
  Definition loc_356 : location_info := LocationInfo file_0 174 34 174 35.
  Definition loc_359 : location_info := LocationInfo file_0 173 11 173 16.
  Definition loc_360 : location_info := LocationInfo file_0 173 11 173 12.
  Definition loc_361 : location_info := LocationInfo file_0 173 11 173 12.
  Definition loc_362 : location_info := LocationInfo file_0 173 15 173 16.
  Definition loc_365 : location_info := LocationInfo file_0 172 2 172 6.
  Definition loc_366 : location_info := LocationInfo file_0 172 2 172 6.
  Definition loc_367 : location_info := LocationInfo file_0 172 2 172 3.
  Definition loc_368 : location_info := LocationInfo file_0 172 2 172 3.
  Definition loc_369 : location_info := LocationInfo file_0 172 4 172 5.
  Definition loc_370 : location_info := LocationInfo file_0 172 9 172 10.
  Definition loc_373 : location_info := LocationInfo file_0 180 2 180 11.
  Definition loc_374 : location_info := LocationInfo file_0 181 2 181 11.
  Definition loc_375 : location_info := LocationInfo file_0 182 2 182 17.
  Definition loc_376 : location_info := LocationInfo file_0 183 2 183 34.
  Definition loc_377 : location_info := LocationInfo file_0 184 2 184 43.
  Definition loc_378 : location_info := LocationInfo file_0 185 2 185 12.
  Definition loc_379 : location_info := LocationInfo file_0 185 9 185 11.
  Definition loc_380 : location_info := LocationInfo file_0 185 9 185 11.
  Definition loc_381 : location_info := LocationInfo file_0 185 10 185 11.
  Definition loc_382 : location_info := LocationInfo file_0 185 10 185 11.
  Definition loc_383 : location_info := LocationInfo file_0 184 11 184 42.
  Definition loc_384 : location_info := LocationInfo file_0 184 11 184 38.
  Definition loc_385 : location_info := LocationInfo file_0 184 17 184 38.
  Definition loc_386 : location_info := LocationInfo file_0 184 17 184 30.
  Definition loc_387 : location_info := LocationInfo file_0 184 17 184 30.
  Definition loc_388 : location_info := LocationInfo file_0 184 31 184 33.
  Definition loc_389 : location_info := LocationInfo file_0 184 31 184 33.
  Definition loc_390 : location_info := LocationInfo file_0 184 35 184 37.
  Definition loc_391 : location_info := LocationInfo file_0 184 36 184 37.
  Definition loc_392 : location_info := LocationInfo file_0 184 41 184 42.
  Definition loc_395 : location_info := LocationInfo file_0 183 17 183 33.
  Definition loc_396 : location_info := LocationInfo file_0 183 17 183 29.
  Definition loc_397 : location_info := LocationInfo file_0 183 28 183 29.
  Definition loc_398 : location_info := LocationInfo file_0 183 28 183 29.
  Definition loc_399 : location_info := LocationInfo file_0 183 32 183 33.
  Definition loc_402 : location_info := LocationInfo file_0 182 11 182 16.
  Definition loc_403 : location_info := LocationInfo file_0 182 11 182 12.
  Definition loc_404 : location_info := LocationInfo file_0 182 11 182 12.
  Definition loc_405 : location_info := LocationInfo file_0 182 15 182 16.
  Definition loc_408 : location_info := LocationInfo file_0 181 2 181 6.
  Definition loc_409 : location_info := LocationInfo file_0 181 2 181 6.
  Definition loc_410 : location_info := LocationInfo file_0 181 2 181 3.
  Definition loc_411 : location_info := LocationInfo file_0 181 2 181 3.
  Definition loc_412 : location_info := LocationInfo file_0 181 4 181 5.
  Definition loc_413 : location_info := LocationInfo file_0 181 9 181 10.
  Definition loc_416 : location_info := LocationInfo file_0 192 2 192 30.
  Definition loc_417 : location_info := LocationInfo file_0 192 9 192 29.
  Definition loc_418 : location_info := LocationInfo file_0 192 15 192 29.
  ...
  Definition impl_int_ptr1 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_15 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_16 (use{PtrOp} (LocInfoE loc_17 ("p"))))) ;
        locinfo: loc_12 ;
        Return (LocInfoE loc_13 (use{IntOp uintptr_t} (LocInfoE loc_14 ("i"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_int_ptr2 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_26 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_27 (use{PtrOp} (LocInfoE loc_28 ("p"))))) ;
        locinfo: loc_23 ;
        Return (LocInfoE loc_24 (use{IntOp uintptr_t} (LocInfoE loc_25 ("i"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_int_ptr3 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_39 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_40 (use{PtrOp} (LocInfoE loc_41 ("p"))))) ;
        locinfo: loc_34 ;
        Return (LocInfoE loc_35 ((LocInfoE loc_36 (use{IntOp uintptr_t} (LocInfoE loc_37 ("i")))) +{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_38 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_38 (i2v 0 i32))))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_min_ptr_val1 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i1" <-{ IntOp uintptr_t }
          LocInfoE loc_67 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_68 (use{PtrOp} (LocInfoE loc_69 ("p1"))))) ;
        "i2" <-{ IntOp uintptr_t }
          LocInfoE loc_62 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_63 (use{PtrOp} (LocInfoE loc_64 ("p2"))))) ;
        locinfo: loc_57 ;
        if{IntOp i32, Some "#1"}: LocInfoE loc_57 ((LocInfoE loc_58 (use{IntOp uintptr_t} (LocInfoE loc_59 ("i1")))) ≤{IntOp uintptr_t, IntOp uintptr_t, i32} (LocInfoE loc_60 (use{IntOp uintptr_t} (LocInfoE loc_61 ("i2")))))
        then
        locinfo: loc_53 ;
          Goto "#2"
        else
      ...
      <[ "#1" :=
        locinfo: loc_49 ;
        Return (LocInfoE loc_50 (use{IntOp uintptr_t} (LocInfoE loc_51 ("i2"))))
      ]> $
      <[ "#2" :=
        locinfo: loc_53 ;
        Return (LocInfoE loc_54 (use{IntOp uintptr_t} (LocInfoE loc_55 ("i1"))))
      ]> $
      <[ "#3" :=
        locinfo: loc_49 ;
        Goto "#1"
  ...
  Definition impl_min_ptr_val2 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i1" <-{ IntOp uintptr_t }
          LocInfoE loc_95 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_96 (use{PtrOp} (LocInfoE loc_97 ("p1"))))) ;
        "i2" <-{ IntOp uintptr_t }
          LocInfoE loc_90 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_91 (use{PtrOp} (LocInfoE loc_92 ("p2"))))) ;
        locinfo: loc_85 ;
        if{IntOp i32, Some "#1"}: LocInfoE loc_85 ((LocInfoE loc_86 (use{IntOp uintptr_t} (LocInfoE loc_87 ("i1")))) ≤{IntOp uintptr_t, IntOp uintptr_t, i32} (LocInfoE loc_88 (use{IntOp uintptr_t} (LocInfoE loc_89 ("i2")))))
        then
        locinfo: loc_81 ;
          Goto "#2"
        else
      ...
      <[ "#1" :=
        locinfo: loc_77 ;
        Return (LocInfoE loc_78 (use{IntOp uintptr_t} (LocInfoE loc_79 ("i2"))))
      ]> $
      <[ "#2" :=
        locinfo: loc_81 ;
        Return (LocInfoE loc_82 (use{IntOp uintptr_t} (LocInfoE loc_83 ("i1"))))
      ]> $
      <[ "#3" :=
        locinfo: loc_77 ;
        Goto "#1"
  ...
  Definition impl_pointer_to_integer_comp_det : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "x" <-{ IntOp i32 } LocInfoE loc_161 (i2v 0 i32) ;
        "y" <-{ IntOp i32 } LocInfoE loc_158 (i2v 0 i32) ;
        "i" <-{ IntOp uintptr_t }
        ...
        locinfo: loc_143 ;
        if{IntOp i32, Some "#1"}: LocInfoE loc_143 ((LocInfoE loc_144 (use{IntOp uintptr_t} (LocInfoE loc_145 ("i")))) <{IntOp uintptr_t, IntOp uintptr_t, i32} (LocInfoE loc_146 (use{IntOp uintptr_t} (LocInfoE loc_147 ("j")))))
        then
        locinfo: loc_136 ;
          Goto "#4"
        else
      ...
      <[ "#1" :=
        locinfo: loc_130 ;
        if{IntOp i32, None}: LocInfoE loc_130 ((LocInfoE loc_131 (use{IntOp uintptr_t} (LocInfoE loc_132 ("i")))) <{IntOp uintptr_t, IntOp uintptr_t, i32} (LocInfoE loc_133 (use{IntOp uintptr_t} (LocInfoE loc_134 ("j")))))
        then
        locinfo: loc_109 ;
          Goto "#2"
        else
      ...
      <[ "#2" :=
        locinfo: loc_109 ;
        assert{IntOp i32}: (LocInfoE loc_115 ((LocInfoE loc_116 (use{IntOp i32} (LocInfoE loc_117 ("y")))) ={IntOp i32, IntOp i32, i32} (LocInfoE loc_118 (i2v 10 i32)))) ;
        locinfo: loc_110 ;
        assert{IntOp i32}: (LocInfoE loc_111 ((LocInfoE loc_112 (use{IntOp i32} (LocInfoE loc_113 ("x")))) ={IntOp i32, IntOp i32, i32} (LocInfoE loc_114 (i2v 0 i32)))) ;
        Return (VOID)
      ]> $
      <[ "#3" :=
        locinfo: loc_120 ;
        assert{IntOp i32}: (LocInfoE loc_126 ((LocInfoE loc_127 (use{IntOp i32} (LocInfoE loc_128 ("x")))) ={IntOp i32, IntOp i32, i32} (LocInfoE loc_129 (i2v 10 i32)))) ;
        locinfo: loc_121 ;
        assert{IntOp i32}: (LocInfoE loc_122 ((LocInfoE loc_123 (use{IntOp i32} (LocInfoE loc_124 ("y")))) ={IntOp i32, IntOp i32, i32} (LocInfoE loc_125 (i2v 0 i32)))) ;
        Return (VOID)
      ]> $
      <[ "#4" :=
        locinfo: loc_136 ;
        LocInfoE loc_137 ("y") <-{ IntOp i32 }
  ...
  Definition impl_roundtrip1 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_176 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_177 (use{PtrOp} (LocInfoE loc_178 ("p"))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_171 (UnOp (CastOp $ PtrOp) (IntOp uintptr_t) (LocInfoE loc_172 (use{IntOp uintptr_t} (LocInfoE loc_173 ("i"))))) ;
        locinfo: loc_168 ;
        Return (LocInfoE loc_169 (use{PtrOp} (LocInfoE loc_170 ("q"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip2 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_195 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_196 (use{PtrOp} (LocInfoE loc_197 ("p"))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_188 (UnOp (CastOp $ PtrOp) (IntOp uintptr_t) (LocInfoE loc_189 ((LocInfoE loc_190 (use{IntOp uintptr_t} (LocInfoE loc_191 ("i")))) +{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_192 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_192 (i2v 0 i32))))))) ;
        locinfo: loc_185 ;
        Return (LocInfoE loc_186 (use{PtrOp} (LocInfoE loc_187 ("q"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip3 (global_copy_alloc_id : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_218 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_219 (use{PtrOp} (LocInfoE loc_220 ("p"))))) ;
        "k" <-{ IntOp uintptr_t }
          LocInfoE loc_212 ((LocInfoE loc_213 (use{IntOp uintptr_t} (LocInfoE loc_214 ("i")))) +{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_215 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_215 (i2v 0 i32))))) ;
        locinfo: loc_204 ;
        Return (LocInfoE loc_205 (Call (LocInfoE loc_207 (global_copy_alloc_id)) [@{expr} LocInfoE loc_208 (use{IntOp uintptr_t} (LocInfoE loc_209 ("k"))) ;
               LocInfoE loc_210 (use{PtrOp} (LocInfoE loc_211 ("p"))) ]))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read1 : function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_242 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_243 (use{PtrOp} (LocInfoE loc_244 ("p"))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_237 (UnOp (CastOp $ PtrOp) (IntOp uintptr_t) (LocInfoE loc_238 (use{IntOp uintptr_t} (LocInfoE loc_239 ("i"))))) ;
        "r" <-{ IntOp i32 }
          LocInfoE loc_231 (use{IntOp i32} (LocInfoE loc_233 (!{PtrOp} (LocInfoE loc_234 ("q"))))) ;
        locinfo: loc_228 ;
        Return (LocInfoE loc_229 (use{IntOp i32} (LocInfoE loc_230 ("r"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read2 (global_copy_alloc_id : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_278 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_279 (use{PtrOp} (LocInfoE loc_280 ("p"))))) ;
        "j" <-{ IntOp uintptr_t }
          LocInfoE loc_272 ((LocInfoE loc_273 (use{IntOp uintptr_t} (LocInfoE loc_274 ("i")))) ×{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_275 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_275 (i2v 1 i32))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_262 (UnOp (CastOp $ PtrOp) (PtrOp) (LocInfoE loc_263 (Call (LocInfoE loc_265 (global_copy_alloc_id)) [@{expr} LocInfoE loc_266 (use{IntOp uintptr_t} (LocInfoE loc_267 ("j"))) ;
          LocInfoE loc_268 (use{PtrOp} (LocInfoE loc_269 ("p"))) ]))) ;
        "r" <-{ IntOp i32 }
          LocInfoE loc_256 (use{IntOp i32} (LocInfoE loc_258 (!{PtrOp} (LocInfoE loc_259 ("q"))))) ;
        locinfo: loc_253 ;
        Return (LocInfoE loc_254 (use{IntOp i32} (LocInfoE loc_255 ("r"))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read3 (global_copy_alloc_id : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_304 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_305 (use{PtrOp} (LocInfoE loc_306 ("p"))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_292 (UnOp (CastOp $ PtrOp) (PtrOp) (LocInfoE loc_293 (Call (LocInfoE loc_295 (global_copy_alloc_id)) [@{expr} LocInfoE loc_296 ((LocInfoE loc_297 (use{IntOp uintptr_t} (LocInfoE loc_298 ("i")))) ×{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_299 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_299 (i2v 1 i32))))) ;
          LocInfoE loc_300 (use{PtrOp} (LocInfoE loc_301 ("p"))) ]))) ;
        locinfo: loc_287 ;
        Return (LocInfoE loc_288 (use{IntOp i32} (LocInfoE loc_290 (!{PtrOp} (LocInfoE loc_291 ("q"))))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read4 (global_copy_alloc_id : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        "i" <-{ IntOp uintptr_t }
          LocInfoE loc_335 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_336 (use{PtrOp} (LocInfoE loc_337 ("p"))))) ;
        "j" <-{ IntOp uintptr_t }
          LocInfoE loc_329 ((LocInfoE loc_330 (use{IntOp uintptr_t} (LocInfoE loc_331 ("i")))) ×{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_332 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_332 (i2v 1 i32))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_319 (UnOp (CastOp $ PtrOp) (PtrOp) (LocInfoE loc_320 (Call (LocInfoE loc_322 (global_copy_alloc_id)) [@{expr} LocInfoE loc_323 (use{IntOp uintptr_t} (LocInfoE loc_324 ("j"))) ;
          LocInfoE loc_325 (use{PtrOp} (LocInfoE loc_326 ("p"))) ]))) ;
        locinfo: loc_314 ;
        Return (LocInfoE loc_315 (use{IntOp i32} (LocInfoE loc_317 (!{PtrOp} (LocInfoE loc_318 ("q"))))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read_past_the_end : function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_343 ;
        LocInfoE loc_366 ((LocInfoE loc_368 ("x")) at_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_369 (i2v 0 i32))) <-{ IntOp i32 }
          LocInfoE loc_370 (i2v 0 i32) ;
        "p" <-{ PtrOp }
          LocInfoE loc_359 ((LocInfoE loc_360 (&(LocInfoE loc_361 ("x")))) at_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_362 (i2v 1 i32))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_351 ((LocInfoE loc_352 (UnOp (CastOp $ PtrOp) (IntOp uintptr_t) (LocInfoE loc_353 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_354 (use{PtrOp} (LocInfoE loc_355 ("p")))))))) at_neg_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_356 (i2v 1 i32))) ;
        locinfo: loc_346 ;
        Return (LocInfoE loc_347 (use{IntOp i32} (LocInfoE loc_349 (!{PtrOp} (LocInfoE loc_350 ("q"))))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_roundtrip_and_read_past_the_end_copy_alloc_id (global_copy_alloc_id : loc): function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_374 ;
        LocInfoE loc_409 ((LocInfoE loc_411 ("x")) at_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_412 (i2v 0 i32))) <-{ IntOp i32 }
          LocInfoE loc_413 (i2v 0 i32) ;
        "p" <-{ PtrOp }
          LocInfoE loc_402 ((LocInfoE loc_403 (&(LocInfoE loc_404 ("x")))) at_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_405 (i2v 1 i32))) ;
        "pi" <-{ IntOp uintptr_t }
          LocInfoE loc_395 ((LocInfoE loc_396 (UnOp (CastOp $ IntOp uintptr_t) (PtrOp) (LocInfoE loc_397 (use{PtrOp} (LocInfoE loc_398 ("p")))))) +{IntOp uintptr_t, IntOp uintptr_t} (LocInfoE loc_399 (UnOp (CastOp $ IntOp uintptr_t) (IntOp i32) (LocInfoE loc_399 (i2v 0 i32))))) ;
        "q" <-{ PtrOp }
          LocInfoE loc_383 ((LocInfoE loc_384 (UnOp (CastOp $ PtrOp) (PtrOp) (LocInfoE loc_385 (Call (LocInfoE loc_387 (global_copy_alloc_id)) [@{expr} LocInfoE loc_388 (use{IntOp uintptr_t} (LocInfoE loc_389 ("pi"))) ;
          LocInfoE loc_390 (&(LocInfoE loc_391 ("x"))) ])))) at_neg_offset{it_layout i32, PtrOp, IntOp i32} (LocInfoE loc_392 (i2v 1 i32))) ;
        locinfo: loc_378 ;
        Return (LocInfoE loc_379 (use{IntOp i32} (LocInfoE loc_381 (!{PtrOp} (LocInfoE loc_382 ("q"))))))
      ]> $∅
    )%E
  |}.
  ...
  Definition impl_cast_NULL : function := {|
    ...
    f_code := (
      <[ "#0" :=
        locinfo: loc_416 ;
        Return (LocInfoE loc_417 (UnOp (CastOp $ IntOp i32) (PtrOp) (LocInfoE loc_418 (NULL))))
      ]> $∅
    )%E
  |}.
End code.
